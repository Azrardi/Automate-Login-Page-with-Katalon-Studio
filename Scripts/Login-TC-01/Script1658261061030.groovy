...
WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/span_Username cannot be empty'), 30)

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_LOGIN Panel_txtUsername'), 'Admin')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_txtPassword'), 'EZJce3R/zYw=')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/input_Password_Submit'))

WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/span_Password cannot be empty'), 30)
